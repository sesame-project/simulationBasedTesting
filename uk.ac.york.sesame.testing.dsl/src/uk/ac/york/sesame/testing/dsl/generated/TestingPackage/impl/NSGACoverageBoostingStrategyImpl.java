...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>NSGA Coverage Boosting Strategy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.sesame.testing.dsl.generated.TestingPackage.impl.NSGACoverageBoostingStrategyImpl#getUseBoostingOnceEveryGenerations <em>Use Boosting Once Every Generations</em>}</li>
 *   <li>{@link uk.ac.york.sesame.testing.dsl.generated.TestingPackage.impl.NSGACoverageBoostingStrategyImpl#getUseBoostingOnceEveryIterations <em>Use Boosting Once Every Iterations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NSGACoverageBoostingStrategyImpl extends MinimalEObjectImpl.Container implements NSGACoverageBoostingStrategy {
	/**
	 ...
	 * @generated
	 */
	protected NSGACoverageBoostingStrategyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TestingPackagePackage.Literals.NSGA_COVERAGE_BOOSTING_STRATEGY;
	}
	...
	public void setUseBoostingOnceEveryGenerations(int newUseBoostingOnceEveryGenerations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackagePackage.NSGA_COVERAGE_BOOSTING_STRATEGY__USE_BOOSTING_ONCE_EVERY_GENERATIONS, oldUseBoostingOnceEveryGenerations, useBoostingOnceEveryGenerations));
	}
	...
	public void setUseBoostingOnceEveryIterations(int newUseBoostingOnceEveryIterations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestingPackagePackage.NSGA_COVERAGE_BOOSTING_STRATEGY__USE_BOOSTING_ONCE_EVERY_ITERATIONS, oldUseBoostingOnceEveryIterations, useBoostingOnceEveryIterations));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TestingPackagePackage.NSGA_COVERAGE_BOOSTING_STRATEGY__USE_BOOSTING_ONCE_EVERY_GENERATIONS:
				return getUseBoostingOnceEveryGenerations();
			case TestingPackagePackage.NSGA_COVERAGE_BOOSTING_STRATEGY__USE_BOOSTING_ONCE_EVERY_ITERATIONS:
...
} //NSGACoverageBoostingStrategyImpl

 ...
 * </p>
 * <ul>
 * <li>{@link uk.ac.york.sesame.testing.dsl.generated.TestingPackage.impl.FixedNSGACoverageBoostingStrategyImpl#getUseBoostingOnceEveryGenerations
 * <em>Use Boosting Once Every Generations</em>}</li>
 * <li>{@link uk.ac.york.sesame.testing.dsl.generated.TestingPackage.impl.FixedNSGACoverageBoostingStrategyImpl#getUseBoostingOnceEveryIterations
 * <em>Use Boosting Once Every Iterations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FixedNSGACoverageBoostingStrategyImpl extends CoverageBoostingStrategyImpl
	...
	/**
	 * The default value of the '{@link #getUseBoostingOnceEveryGenerations()
	 * <em>Use Boosting Once Every Generations</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getUseBoostingOnceEveryGenerations() <em>Use
	 * Boosting Once Every Generations</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getUseBoostingOnceEveryGenerations()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getUseBoostingOnceEveryIterations() <em>Use
	 * Boosting Once Every Iterations</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getUseBoostingOnceEveryIterations() <em>Use
	 * Boosting Once Every Iterations</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getUseBoostingOnceEveryIterations()
	...
	public void setUseBoostingOnceEveryGenerations(int newUseBoostingOnceEveryGenerations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestingPackagePackage.FIXED_NSGA_COVERAGE_BOOSTING_STRATEGY__USE_BOOSTING_ONCE_EVERY_GENERATIONS,
					oldUseBoostingOnceEveryGenerations, useBoostingOnceEveryGenerations));
	}
	...
	public void setUseBoostingOnceEveryIterations(int newUseBoostingOnceEveryIterations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestingPackagePackage.FIXED_NSGA_COVERAGE_BOOSTING_STRATEGY__USE_BOOSTING_ONCE_EVERY_ITERATIONS,
					oldUseBoostingOnceEveryIterations, useBoostingOnceEveryIterations));
	}

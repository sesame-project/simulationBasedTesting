 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.sesame.testing.dsl.generated.TestingPackage.Attacks.impl.StringRangeImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link uk.ac.york.sesame.testing.dsl.generated.TestingPackage.Attacks.impl.StringRangeImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringRangeImpl extends ValueRangeImpl implements StringRange {
	...
	protected EClass eStaticClass() {
		return AttacksPackage.Literals.STRING_RANGE;
	}
	...
	public void setLowerBound(String newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AttacksPackage.STRING_RANGE__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(String newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AttacksPackage.STRING_RANGE__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AttacksPackage.STRING_RANGE__LOWER_BOUND:
				return getLowerBound();
			case AttacksPackage.STRING_RANGE__UPPER_BOUND:

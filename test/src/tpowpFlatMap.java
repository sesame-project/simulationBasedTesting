...
public class tpowpFlatMap implements FlatMapFunction<EventMessage,EventMessage> {
	...
	public tpowpFlatMap(String topic, String start, String end, Map<String, DoubleRange> possibleValues) {
		this.topic = topic;
		this.start = start;
		this.end = end;

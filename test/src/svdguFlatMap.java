...
public class svdguFlatMap implements FlatMapFunction<EventMessage,EventMessage> {
	...
	public svdguFlatMap(String topic, String start, String end, Map<String, DoubleRange> possibleValues) {
		this.topic = topic;
		this.start = start;
		this.end = end;

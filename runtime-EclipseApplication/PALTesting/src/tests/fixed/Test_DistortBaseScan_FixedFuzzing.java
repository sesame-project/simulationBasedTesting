...
public class Test_DistortBaseScan_FixedFuzzing {
	public static void main(String[] args) {
		...
		params.put("launchPath", "/home/jharbin/academic/pal/run_pal_cuda_v4.sh");
		
		// Preprocessing before simulation starts
		System.out.println("Preprocessing Phase");
		
		FuzzingOperation fuzzOp0 = new DistortBaseScanPMB2_FixedFuzzing(); // TODO: add the timing/condition in a comment here; 

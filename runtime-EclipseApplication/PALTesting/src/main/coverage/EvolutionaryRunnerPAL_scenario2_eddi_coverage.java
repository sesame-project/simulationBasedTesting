...
public class EvolutionaryRunnerPAL_scenario2_eddi_coverage {
	...
	public static void main(String [] args) {
		...
		// PATHS HERE
		final String spaceModelFileName = "/home/jharbin/eclipse-workspace/PALTesting/models/test/TestingPAL-coverage.model";
		...
		String campaignToRun = "scenario2-eddi-timebased-faults-coverage";

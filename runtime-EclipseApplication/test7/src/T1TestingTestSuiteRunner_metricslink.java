...
public class T1TestingTestSuiteRunner_metricslink {
	...
	public static void main(String[] args) {
		...
		DataStream<MetricMessage> metricMsg1 = TrackPacketLossRatioresStream.map(d -> new MetricMessage("T1TestingTestSuiteRunner_metricslink", "TrackPacketLossRatio", d));
		DataStream<MetricMessage> metricMsg2 = DistanceToPointresStream.map(d -> new MetricMessage("T1TestingTestSuiteRunner_metricslink", "DistanceToPointresStream", d));
		
		// Union the metric result output streams together here
		DataStream<MetricMessage> allMetrics = metricMsg1.union(metricMsg2);

...
public class Test_Stalling_Corner2 {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_07_09_2022_12_29_20";
		...
		FuzzingOperation fuzzOp0 = new distortBaseScanCustomOp_Test_001_07_09_2022_12_29_20("/base_scan",35.2005967424104,48.24267580677697,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_07_09_2022_12_29_20");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_07_09_2022_12_29_20");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(6.042079064366575));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_07_09_2022_12_29_20", "fuzzingOperationTimes", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsguvExposureForHuman = uvExposureForHumanresStream.map(d -> new MetricMessage("Test_001_07_09_2022_12_29_20", "uvExposureForHuman", d));

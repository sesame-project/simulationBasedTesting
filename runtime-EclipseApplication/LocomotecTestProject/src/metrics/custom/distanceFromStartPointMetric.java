...
public class distanceFromStartPointMetric extends Metric {
	...
	public void open(Configuration parameters) throws Exception {
		robotStartingPos = getRuntimeContext()
				.getMapState(new MapStateDescriptor<>("robotStartingPos", String.class, Point.class));
		robotCurrentPos = getRuntimeContext()
				.getMapState(new MapStateDescriptor<>("robotCurrentPos", String.class, Point.class));
	}

	public distanceFromStartPointMetric() {

...
public class Test_001_31_08_2022_12_48_04_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_31_08_2022_12_48_04";
		...
		FuzzingOperation fuzzOp0 = new distortBaseScanCustomOp_Test_001_31_08_2022_12_48_04("/base_scan",10.702366893809845,235.0,0); 
		...
		Thread subscriber_thread_move_base_simple_goal = new Thread() {
			public void run() {
				System.out.println("Subscriber move_base_simple_goal Starts");
				rosSim.consumeFromTopic("move_base_simple/goal", "double", true, "IN");
			}
		};
		subscriber_thread_move_base_simple_goal.start();
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_31_08_2022_12_48_04");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_31_08_2022_12_48_04");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(22.628653211173685));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsguvExposureForHuman = uvExposureForHumanresStream.map(d -> new MetricMessage("Test_001_31_08_2022_12_48_04", "uvExposureForHuman", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_31_08_2022_12_48_04", "fuzzingOperationTimes", d));
		
		
		DataStream<MetricMessage> allMetrics = 		
		metricMsguvExposureForHuman

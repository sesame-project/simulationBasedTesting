...
public class Test_001_13_09_2022_14_13_03_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_13_09_2022_14_13_03";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_13_09_2022_14_13_03("joints/R270072/Link1/R/position",992.8570040477655,996.2453546094958,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_13_09_2022_14_13_03");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_13_09_2022_14_13_03");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(3.3883505617303626));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_13_09_2022_14_13_03", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_13_09_2022_14_13_03", "fuzzingOperationTimes", d));

...
public class attackJointPosR270072_0FlatMap_Test_001_14_09_2022_13_15_50 extends TimeBasedFuzzingOperation {


	private static final long serialVersionUID = 1L;
	Random rng;

	public attackJointPosR270072_0FlatMap_Test_001_14_09_2022_13_15_50(String topic, double start, double end, long seed) {
	...
	public void processElement1(EventMessage value, Context ctx, Collector<EventMessage> out) throws Exception { 
			if (value.getTopic().equals(topic) && isReadyNow()) {
				Object obj = JSONValue.parse(value.getValue().toString());
	      		...
	      		jo = ParsingUtils.updateJSONObject(jo, "", new DoubleRange(0.9980642758728397, 0.9997498597157312).generateInRange(rng));

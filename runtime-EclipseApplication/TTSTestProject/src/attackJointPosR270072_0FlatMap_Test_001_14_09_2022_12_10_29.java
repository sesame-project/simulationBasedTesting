...
public class attackJointPosR270072_0FlatMap_Test_001_14_09_2022_12_10_29 extends TimeBasedFuzzingOperation {


	private static final long serialVersionUID = 1L;
	Random rng;

	public attackJointPosR270072_0FlatMap_Test_001_14_09_2022_12_10_29(String topic, double start, double end, long seed) {
	...
	public void processElement1(EventMessage value, Context ctx, Collector<EventMessage> out) throws Exception { 
			if (value.getTopic().equals(topic) && isReadyNow()) {
				Object obj = JSONValue.parse(value.getValue().toString());
	      		...
	      		jo = ParsingUtils.updateJSONObject(jo, "", new DoubleRange(0.8370969518486244, 0.9147789942795596).generateInRange(rng));

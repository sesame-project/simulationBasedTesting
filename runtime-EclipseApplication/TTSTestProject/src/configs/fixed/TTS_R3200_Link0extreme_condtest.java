...
public class TTS_R3200_Link0extreme_condtest {
	public static void main(String[] args) {
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR3200ProductMove_condtest("joints/R3200ProductMove/Link0/R/position",0); 

...
public class TTS_Zone_Condtest {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_04_12_2022_22_34_08";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR3200ProductMove_Link1FlatMap_Test_zone_condtest("joints/R3200ProductMove/Link1/R/position",455343435L); 
		...
		Thread subscriber_thread_safetyzones_Z4 = new Thread() {
			public void run() {
				System.out.println("Subscriber safetyzones_Z4 Starts");
				ttsSim.consumeFromTopic("safetyzones/Z4", "SafetyZone", true, "IN", false);
			}
		};
		subscriber_thread_safetyzones_Z4.start();
		...
		Thread subscriber_thread_safetyzones_Z6 = new Thread() {
			public void run() {
				System.out.println("Subscriber safetyzones_Z6 Starts");
				ttsSim.consumeFromTopic("safetyzones/Z6", "SafetyZone", true, "IN", false);
			}
		};
		subscriber_thread_safetyzones_Z6.start();
		...
		Thread subscriber_thread_safetyzones_Z5 = new Thread() {
			public void run() {
				System.out.println("Subscriber safetyzones_Z5 Starts");
				ttsSim.consumeFromTopic("safetyzones/Z5", "SafetyZone", true, "IN", false);
			}
		};
		subscriber_thread_safetyzones_Z5.start();
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_04_12_2022_22_34_08");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_04_12_2022_22_34_08");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
				...
				DataStream<Double> entryToTriggerZone3resStream = eventsAndControlIn.process(new entryToTriggerZone3Metric());
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgjointExtremeR3200Link1Pos = jointExtremeR3200Link1PosresStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "jointExtremeR3200Link1Pos", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "fuzzingOperationTimes", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgjointExtremeR3200Link1Neg = jointExtremeR3200Link1NegresStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "jointExtremeR3200Link1Neg", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgentryToTriggerZone1 = entryToTriggerZone1resStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "entryToTriggerZone1", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgentryToTriggerZone2 = entryToTriggerZone2resStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "entryToTriggerZone2", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgjointExtremeR3200Link0Pos = jointExtremeR3200Link0PosresStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "jointExtremeR3200Link0Pos", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgjointExtremeR3200Link0Neg = jointExtremeR3200Link0NegresStream.map(d -> new MetricMessage("Test_001_04_12_2022_22_34_08", "jointExtremeR3200Link0Neg", d));
		
 

				final FileSink<String> jointExtremeR3200Link1PosstreamFileSink = FileSink
				    .forRowFormat(new Path("/tmp/collisionOccurance-Test_001_04_12_2022_22_34_08"), new SimpleStringEncoder<String>("UTF-8"))
			    	.withRollingPolicy(
				...
				final FileSink<String> fuzzingOperationTimesstreamFileSink = FileSink
				    .forRowFormat(new Path("/tmp/fuzzopTimes-Test_001_04_12_2022_22_34_08"), new SimpleStringEncoder<String>("UTF-8"))
			    	.withRollingPolicy(
				        DefaultRollingPolicy.builder()
			            	.withRolloverInterval(TimeUnit.MINUTES.toMillis(150))
			            	.withInactivityInterval(TimeUnit.MINUTES.toMillis(50))
		...
		metricMsgjointExtremeR3200Link1Pos

...
public class Test_001_13_09_2022_14_12_13_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_13_09_2022_14_12_13";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_13_09_2022_14_12_13("joints/R270072/Link1/R/position",699.2798997892802,736.9564894167697,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_13_09_2022_14_12_13");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_13_09_2022_14_12_13");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(37.676589627489534));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_13_09_2022_14_12_13", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_13_09_2022_14_12_13", "fuzzingOperationTimes", d));

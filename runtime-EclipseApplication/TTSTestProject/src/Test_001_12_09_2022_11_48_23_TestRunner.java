...
public class Test_001_12_09_2022_11_48_23_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_12_09_2022_11_48_23";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_12_09_2022_11_48_23("joints/R270072/Link1/R/position",364.4285407869593,538.8851926838536,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_12_09_2022_11_48_23");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_12_09_2022_11_48_23");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(174.4566518968943));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_12_09_2022_11_48_23", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_12_09_2022_11_48_23", "fuzzingOperationTimes", d));

...
public class Test_001_TTS_Hacked_newinterface {
	public static void main(String[] args) {
		...
		//joints/R3200ProductMove/Link1/R/position
...
//		System.out.println("Connecting to topics");					
//		Thread subscriber_thread_joints_2 = new Thread() {
//			public void run() {
//				System.out.println("Subscriber joints_2 Starts");
//				ttsSim.consumeFromTopic("joints/R3200ProductMove/Link1/R/position", "double", true, "IN");
//			}
//		};
//		subscriber_thread_joints_2.start();
			...
			public void run() {
				...
				while (true) {
					...
					for (ConsumerRecord<Long, EventMessage> record : cr) {
						...
						System.out.println("OUT TO SIM: inTopic = " + inTopic + " -> " + outTopic + ":" + record.value());

...
public class attackJointPosR270072_0FlatMap_Test_001_30_08_2022_13_18_18 extends TimeBasedFuzzingOperation {


	private static final long serialVersionUID = 1L;
	Random rng;

	public attackJointPosR270072_0FlatMap_Test_001_30_08_2022_13_18_18(String topic, double start, double end, long seed) {
	...
	public void processElement1(EventMessage value, Context ctx, Collector<EventMessage> out) throws Exception { 
			if (value.getTopic().equals(topic) && isReadyNow()) {
				Object obj = JSONValue.parse(value.getValue().toString());
	      		...
	      		jo = ParsingUtils.updateJSONObject(jo, "", new DoubleRange(0.3610174734413184, 0.4762684978168296).generateInRange(rng));

...
public class Test_001_30_08_2022_13_18_18_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_30_08_2022_13_18_18";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_30_08_2022_13_18_18("joints/R270072/Link1/R/position",272.4516085961185,751.6942214615965,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_30_08_2022_13_18_18");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_30_08_2022_13_18_18");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(479.242612865478));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_30_08_2022_13_18_18", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_30_08_2022_13_18_18", "fuzzingOperationTimes", d));

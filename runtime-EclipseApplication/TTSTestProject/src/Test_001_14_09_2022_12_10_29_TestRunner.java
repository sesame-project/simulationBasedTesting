...
public class Test_001_14_09_2022_12_10_29_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_14_09_2022_12_10_29";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_14_09_2022_12_10_29("joints/R270072/Link1/R/position",508.3653912532944,752.1663011928026,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_14_09_2022_12_10_29");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_14_09_2022_12_10_29");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(243.80090993950824));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_14_09_2022_12_10_29", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_14_09_2022_12_10_29", "fuzzingOperationTimes", d));

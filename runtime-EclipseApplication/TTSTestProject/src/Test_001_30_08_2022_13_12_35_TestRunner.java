...
public class Test_001_30_08_2022_13_12_35_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_30_08_2022_13_12_35";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_30_08_2022_13_12_35("joints/R270072/Link1/R/position",703.8531812625142,838.3077955058682,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_30_08_2022_13_12_35");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_30_08_2022_13_12_35");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(134.45461424335394));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_30_08_2022_13_12_35", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_30_08_2022_13_12_35", "fuzzingOperationTimes", d));

...
public class Test_001_09_09_2022_12_24_50_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_09_09_2022_12_24_50";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_09_09_2022_12_24_50("joints/R270072/Link1/R/position",491.072507619337,553.4076839840241,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_09_09_2022_12_24_50");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_09_09_2022_12_24_50");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(62.33517636468707));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_09_09_2022_12_24_50", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_09_09_2022_12_24_50", "fuzzingOperationTimes", d));

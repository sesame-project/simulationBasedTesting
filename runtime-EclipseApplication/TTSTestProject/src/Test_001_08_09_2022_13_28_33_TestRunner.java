...
public class Test_001_08_09_2022_13_28_33_TestRunner {
	public static void main(String[] args) {
	
		final String TESTNAME = "Test_001_08_09_2022_13_28_33";
		...
		FuzzingOperation fuzzOp0 = new attackJointPosR270072_0FlatMap_Test_001_08_09_2022_13_28_33("joints/R270072/Link1/R/position",944.3413608221549,996.8787610586407,0); 
		...
		KeyedStream<EventMessage, String> testKeyedIn = stream.keyBy(value -> "Test_001_08_09_2022_13_28_33");
		KeyedStream<EventMessage, String> testKeyedOut = streamOut.keyBy(value -> "Test_001_08_09_2022_13_28_33");;
		...
		List<Double> fuzzOpTimes = new ArrayList<Double>(); 
			...
			fuzzOpTimes.add(Double.valueOf(52.53740023648584));
		...
		simcore.setTestName(TESTNAME);
			...
			DataStream<MetricMessage> metricMsgcollisionOccurance = collisionOccuranceresStream.map(d -> new MetricMessage("Test_001_08_09_2022_13_28_33", "collisionOccurance", d));
 
			// Generate a message stream for all metrics
			DataStream<MetricMessage> metricMsgfuzzingOperationTimes = fuzzingOperationTimesresStream.map(d -> new MetricMessage("Test_001_08_09_2022_13_28_33", "fuzzingOperationTimes", d));

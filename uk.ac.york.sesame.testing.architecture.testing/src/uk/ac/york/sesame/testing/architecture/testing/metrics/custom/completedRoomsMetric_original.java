package uk.ac.york.sesame.testing.architecture.testing.metrics.custom;
...
public class completedRoomsMetric_original extends ProcessFunction<EventMessage, Double> {
    ...
    public void processElement(EventMessage msg, Context ctx, Collector<Double> out) throws Exception {
    	...
    	if (msg.getTopic().contains(completionTopicName)) {
    		...
    		System.out.println("completedRoomsMetric: received notification of room " + v + " completed");
